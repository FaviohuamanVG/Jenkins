...
public class WebClientConfig {
    ...
    /**
     * Bean de WebClient.Builder configurado con timeouts y configuraciones para microservicios
     */
    @Bean
    public WebClient.Builder webClientBuilder() {
        ...
        HttpClient httpClient = HttpClient.create()
                .option(ChannelOption.CONNECT_TIMEOUT_MILLIS, 5000) // 5 segundos conexión
                .responseTimeout(Duration.ofSeconds(10)) // 10 segundos respuesta
                .doOnConnected(conn -> 
